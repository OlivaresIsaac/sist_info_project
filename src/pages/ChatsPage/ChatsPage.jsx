        ...
        <div className="min-h-screen grid grid-cols-1 xl:grid-cols-4 bg-[#0B131A] text-gray-300">
            ...
            <div className="hidden bg-[#1B2831] xl:flex flex-col">
                ...
                <div className="h-[85vh] overflow-y-scroll">
                    {/*Cliente*/}
                    <div 
                        className="p-4 flex items-center gap-4 bg-[#222C32] border-b border-[#222C32] hover:cursor-pointer"
                    >
                        <img
                        ...
                        <div className="flex-1 flex justify-between">
                            ...
                            <div className="text-gray-500 text-xs">14:23</div>
                        </div>
                    </div>
                    {/*Cliente*/}
                    <div
                        className="p-4 flex items-center gap-4 hover:bg-[#222C32] border-b border-[#222C32] transition-colors hover:cursor-pointer"
                    >
                        <img
                            src="https://img.freepik.com/foto-gratis/alegre-joven-pie-aislado-sobre-pared-naranja_171337-16567.jpg"
                            className="w-10 h-10 object-cover rounded-full"
                        ...
                        <div className="flex-1 flex justify-between">
                            ...
                            <div className="text-gray-500 text-xs">12:12</div>
                        </div>
                    </div>
                    {/*Cliente*/}
                    <div
                    ...
                    >
                        ...
                        <div className="flex-1 flex justify-between">
                            ...
                            <div className="text-gray-500 text-xs">miércoles</div>
                        </div>
                    </div>
                    {/*Cliente*/}
                    <div
                    ...
                    >
                        ...
                        <div className="flex-1 flex justify-between">
                            ...
                            <div className="text-gray-500 text-xs">6:55</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="xl:col-span-3">
                ...
                <div className="h-[8vh] text-gray-500 flex items-center bg-[#1B2831]">
                    <div className="w-[20%] xl:w-1/12 flex justify-center text-2xl">
                        <RiEmotionLine className="hover:cursor-pointer"/>
                    </div>
                    <form className="w-[60%] xl:w-10/12">
                        <input type="text" className="bg-[#0B131A] w-full py-2 px-6 rounded-full outline-none text-gray-300"
